  ...
  const gettingStarted = [
    {
      ...
      action: 'Start a "Small Joys" habit. Each morning or evening, identify one beautiful thing you saw or experienced. It could be the color of the sky or a kind word from a stranger. By focusing on the positive, you naturally align your vibration with the Divine.',
    },
    {
      ...
      action: 'Place a single, fresh flower in a vase where you will see it often. Meishu-sama emphasized that even one flower can radiate enough light to change the atmosphere of a room. Focus on its life and color for a few moments each day.',
    },
    {
      ...
      action: 'Receiving Johrei is a quiet, meditative experience where a practitioner channels light to you. Most newcomers describe a sense of deep warmth, peace, and a lightness of spirit following a session.',
    },
    {
      title: '4. Choose "Living" Foods',
      body: 'Aligning with nature starts with what we put into our bodies.',
      action: 'When shopping, try to incorporate one piece of naturally grown or organic produce into your meal. As you eat, take a moment to acknowledge the energy of the soil and the sun that allowed the food to grow.',
    },
  ]

  usePageMeta({
    title: 'Welcome to the World Messianic Church of Canada | World Messianic Church of Canada',
    description:
    ...
    <div className="min-h-screen bg-sanctuary-100 text-deep-slate">
      <section className="border-b border-[rgba(184,134,11,0.2)] bg-white px-6 pt-32 pb-20 text-center">
        <div className="mx-auto max-w-5xl space-y-6">
          ...
          <h1 className="text-4xl font-serif leading-tight md:text-6xl">Welcome to the World Messianic Church of Canada</h1>
        </div>
      </section>
      ...
      <Section className="bg-white">
        <div className="mx-auto max-w-4xl space-y-6">
          ...
          <p className="text-lg leading-relaxed text-slate-700">
            In Canada, we are a bilingual community welcoming all to experience this transformation. Whether through Johrei, the study of sacred teachings, or the appreciation of art and nature, our mission is to help every individual awaken to their divine nature and contribute to a global civilization of light.
          </p>
        </div>
      </Section>
      ...
      <Section className="bg-sanctuary-100 border-y border-[rgba(184,134,11,0.2)]">
        <div className="mx-auto max-w-5xl space-y-8">
          ...
          <p className="text-lg leading-relaxed text-slate-600">
            You don&apos;t need to be a scholar or a lifelong practitioner to begin experiencing the principles
            Meishu-sama shared. His teachings are designed to be lived. Here are four simple ways you can begin
            incorporating his philosophy into your daily life:
          </p>
            ...
            {gettingStarted.map((item) => (
              <Card key={item.title} title={item.title} className="border-[rgba(184,134,11,0.2)] bg-white p-8">
                ...
                {item.title.startsWith('3.') ? (
                  <div className="mt-5">
                    <ButtonLink to="/locations" variant="accent">Find a Center Near You</ButtonLink>
                  </div>
                ) : null}
              </Card>
            ))}
          ...
          <Card className="border-[rgba(184,134,11,0.2)] bg-white p-8">
            ...
            <p className="mt-3 text-base leading-relaxed text-slate-600">
              Meishu-sama&apos;s path is one of Self-Reform. It is not about changing the world through force, but
              about refining our own hearts so that peace naturally ripples outward to our families, our communities,
      ...
      <Section className="border-y border-[rgba(184,134,11,0.2)] bg-sanctuary-100">
        <div className="mx-auto max-w-4xl rounded-3xl border border-[rgba(184,134,11,0.25)] bg-white p-8 md:p-10 text-center">
          ...
          <p className="mt-3 text-base leading-relaxed text-slate-600">
            Learn more about Johrei, our teachings, and how to experience this path in Canada.
          </p>
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <ButtonLink to="/johrei" variant="secondary">Johrei</ButtonLink>
            <ButtonLink to="/meishu-sama" variant="outline">Meishu-Sama</ButtonLink>
