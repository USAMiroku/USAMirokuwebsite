...
export default function Events() {
  ...
  usePageMeta({
    ...
    description:
      'Upcoming events, monthly appreciation services, and community gatherings at World Messianic Church of America / Miroku Association USA.',
  })
    ...
    <div className="relative min-h-screen bg-sanctuary-100 text-deep-slate">
      ...
      <section className="relative py-32 md:py-48 flex flex-col items-center justify-center text-center px-6">
        <div className="max-w-4xl mx-auto space-y-8">
          <span className="text-[10px] font-bold tracking-[0.4em] text-sage-600 uppercase">Sacred Gatherings</span>
          <h1 className="text-6xl md:text-8xl font-serif text-deep-slate leading-tight">{t.events.title}</h1>
      ...
      <Section py-32 className="bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="p-16 md:p-24 rounded-sanctuary-lg border border-slate-100 bg-sanctuary-50/50 text-center space-y-12">
            ...
            <p className="text-xl text-slate-600 font-serif italic leading-relaxed">{t.events.empty}</p>
            <p className="text-slate-500 max-w-lg mx-auto leading-relaxed">
              We hold regular monthly appreciation services and weekly Johrei sessions across the United States. Contact your local center to receive the full schedule.
            </p>
            <div className="pt-8">
