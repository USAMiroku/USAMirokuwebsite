...
export const translations: Record<string, TranslationContent> = {
  en: {
    ...
    usa: {
      ...
      contact: {
        ...
        activitiesCta: 'See Events Calendar',
  ...
  es: {
    ...
    nav: {
      ...
      locations: 'Centros',
      events: 'Eventos',
      activities: 'Calendario de Eventos',
      books: 'Libros',
      resources: 'Recursos',
    ...
    usa: {
      ...
      contact: {
        ...
        activitiesCta: 'Ver calendario de eventos',
  ...
  pt: {
    ...
    nav: {
      ...
      locations: 'Centros',
      events: 'Eventos',
      activities: 'Calendário de Eventos',
      books: 'Livros',
      resources: 'Recursos',
    ...
    usa: {
      ...
      contact: {
        ...
        activitiesCta: 'Ver calendário de eventos',
